...
func BuildSystemPromptWithPaths(basePrompt string, shellContext OpAgentShellContext, cwdAgentsPath string, availableSkills, selectedSkills []SkillContext, selectedSkillContext map[string]any) string {

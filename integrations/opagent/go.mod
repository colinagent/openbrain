module github.com/colinagent/openbrain/integrations/opagent

go 1.26.3

require (
	github.com/colinagent/opagent/opagent-protocol/go-sdk v0.1.0
	github.com/colinagent/opagent/opagent-runtime v0.1.0
)
